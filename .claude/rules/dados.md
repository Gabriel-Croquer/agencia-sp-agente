...
## 3b. Validar — detectar anomalias antes de analisar

Antes de calcular tendencias ou comparacoes, execute estas verificacoes:

1. **Razoes extremas**: calcule max/mediana de cada coluna numerica.
   Se razao > 5x, PARE e investigue antes de prosseguir
2. **Saltos temporais**: em series de tempo, compare cada periodo com os adjacentes.
   Saltos > 3x entre periodos exigem investigacao (mudanca de metodologia? erro de extracao?)
3. **Lacunas**: verifique se ha meses, anos ou categorias faltantes na serie
4. **Amostra minima**: porcentagens sobre bases pequenas (<30 casos) sao enganosas.
   Sinalize com [AMOSTRA PEQUENA]
5. Se encontrar anomalia nao explicada, sinalize com **[VERIFICAR DADO]** e
   NAO inclua o dado em calculos de tendencia ate esclarecer

Regra: nenhuma conclusao jornalistica deve se basear em dado anomalo nao investigado.
